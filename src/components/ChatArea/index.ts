...
export { SubTopicTabs } from './SubTopicTabs';
export { InlineConfigPanel } from './InlineConfigPanel';
...
export type { SubTopicTabsProps } from './SubTopicTabs';
export type { InlineConfigPanelProps } from './InlineConfigPanel';
